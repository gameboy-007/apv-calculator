...
st.caption("A Centralia-style APV computation app with user inputs for international project valuation.")
...
freed_up_usd = st.number_input("Freed-up affiliate funds (USD, if any)", value=185_625.0, step=1000.0)
...
if st.button("📈 Calculate APV"):
    ...
    st.info("💡 Tip: Adjust growth rates and inflation assumptions to test sensitivity across different scenarios.")
